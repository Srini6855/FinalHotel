...
Feature: Explore Hotels Module
  ...
  Scenario Outline: Search hotels with all fields
    ...
    Examples: 
      ...
      | srinipmps@gmail.com | abEuKW6S@asg3Nv | Tamil Nadu | Coimbatore | Deluxe   | 2024-06-23 | 2024-06-26 | 1-One      | 3-Three      |            2 |
  ...
  Scenario Outline: Search hotels with only mandatory fields
    ...
    Examples: 
      ...
      | srinipmps@gmail.com | abEuKW6S@asg3Nv | Tamil Nadu | Coimbatore | 2024-06-23 | 2024-06-26 | 1-One      | 3-Three      |
  ...
  Scenario Outline: Search hotels with all fields and select all room type
    ...
    Examples: 
      | userName            | password        | state      | city       | roomType                            | checkIn    | check-out  | No of Room | No of Adults | No of Childs |
      | srinipmps@gmail.com | abEuKW6S@asg3Nv | Tamil Nadu | Coimbatore | Standard/Deluxe/Suite/Luxury/Studio | 2024-06-23 | 2024-06-26 | 1-One      | 3-Three      |            2 |
